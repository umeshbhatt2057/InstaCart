        ...
        {loading ? (
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1'>
              <p className='text-red-600 '>{displayINRCurrency(sellingPrice)}</p>
              <p className='text-slate-400 line-through text-2xl'>{displayINRCurrency(originalPrice)}</p>
              {discount > 0 && (
                <p className='text-white font-medium text-sm bg-green-500 px-2 py-1 rounded-full inline-block ml-2'>
            ...
            <div className='flex items-center gap-3 my-2'>
              <button
                className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] text-red-600 font-medium hover:bg-red-600 hover:text-white transition duration-300'
